...
update_option('activated_purchase_date' , '10.10.2023');
update_option('activated_support_date' , '10.10.2040');
 ...
 */
function nayla_add_dashboard_widgets() {
	wp_add_dashboard_widget(
		'nayla_dashboard_widget',                          // Widget slug.
		esc_html__( 'Example Dashboard Widget', 'nayla' ), // Title.
		'nayla_dashboard_widget_render'                    // Display function.
	); 
}
add_action( 'wp_dashboard_setup', 'nayla_add_dashboard_widgets' );
